// Create a struct for each facet's variable (to subsection more then create struct for each function or each need  )

// do not put a struct directly in a struct eg reputationStorage { bla{} } - unless its ok with not being upgradeable

// below is a reference implementation of appstorage from eip2535 page
